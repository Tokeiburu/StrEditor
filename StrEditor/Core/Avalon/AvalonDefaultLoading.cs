...
using SearchPanel = StrEditor.View.Controls.SearchPanel;

namespace StrEditor.Core.Avalon {
			...
			new Thread(new ThreadStart(delegate {
				lock (_lock) {
					try {
						...
						ICSharpCode.AvalonEdit.Search.RegexSearchStrategy strategy = new ICSharpCode.AvalonEdit.Search.RegexSearchStrategy(pattern, true);
